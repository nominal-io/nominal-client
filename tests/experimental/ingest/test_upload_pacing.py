...
class TestThrottleGateDeadlines:
    ...
    def test_backoff_sleeps_consume_the_budget(self, make_gate: MakeGate) -> None:
        """Backoff sleeps spend the same budget as attempts do.
