...
class ClientsBunch:
    ...
    logical_series: timeseries_logicalseries.LogicalSeriesService | None
    ...
    def from_config(
        ...
        return cls(
            ...
            logical_series=client_factory(timeseries_logicalseries.LogicalSeriesService) if timeseries_logicalseries is not None else None,
...
def api_base_url_to_app_base_url(api_base_url: str, fallback: str = "") -> str:
    ...
    Examples:
    - https://hw-tums.api-staging.gov.nominal.io/api -> https://app.gov.nominal.io
