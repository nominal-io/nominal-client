...
from nominal.core.channel import ChannelDataType, _to_pandas_timestamp
...
class Channel:
    ...
    ) -> pd.Series[Any]:  # TODO @v-tupuri - talk to ritwik. We dont wanna use RID
    ...
    def _decimate_request(
        ...
        buckets: int | None = None,
        resolution: int | None = None,
    ) -> scout_compute_api.ComputeNodeResponse:  # TODO @v-tupuri - talk to ritwik. We dont wanna use RID
        # TODO if not enum or numeric, throw error - talk to greg/joy abt logs
    ...
    def get_series_values_csv(
        ...
        """
        # TODO @v-tupuri - speak with greg/joy abt log data type and whether ritwik should add channelseries to the api
