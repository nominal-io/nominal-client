...
def search_containerized_extractors_paginated(
    ...
    *,
    ...
    def factory(page_token: str) -> containerized_extractor_pb2.SearchContainerizedExtractorsRequest:
        request = containerized_extractor_pb2.SearchContainerizedExtractorsRequest(
        ...
        if page_token:
            request.next_page_token = page_token
        return request
...
def search_container_images_paginated(
    ...
    *,
    ...
    def factory(page_token: str) -> registry_pb2.SearchImagesRequest:
        request = registry_pb2.SearchImagesRequest(workspace_rid=workspace_rid, page_size=DEFAULT_PAGE_SIZE)
        if search_filter is not None:
            request.filter.CopyFrom(search_filter)
        if page_token:
            request.next_page_token = page_token
        return request
